    ...
    *loadModel() {
      ...
      let mappedStandings = fifaStandings.map(standing => {
        return {
          ...
          isLive: liveFixtures.any(fixture => fixture.AwayTeam.IdCountry === standing.Team.IdCountry || fixture.HomeTeam.IdCountry === standing.Team.IdCountry),
          lost: standing.Lost,
...
;define("worldcup/templates/application", ["exports"], function (_exports) {
  ...
  var _default = Ember.HTMLBars.template({
    "id": "0DxwFcfs",
    "block": "[[[10,0],[14,0,\"absolute inset-0 overflow-auto bg-slate\"],[12],[1,\"\\n  \"],[10,0],[14,0,\"sticky flex flex-row justify-center top-0 p-2 bg-boulder border-b-2 border-worldcup rounded-b-md shadow-sm\"],[12],[1,\"\\n    \"],[10,\"embed\"],[14,\"src\",\"/assets/svg/logo.svg\"],[14,0,\"max-h-6\"],[12],[13],[1,\"\\n  \"],[13],[1,\"\\n  \"],[10,0],[14,0,\"flex flex-col flex-1 h-full\"],[12],[46,[28,[37,1],null,null],null,null,null],[13],[1,\"\\n\"],[13],[1,\";\\n\"]],[],false,[\"component\",\"-outlet\"]]",
...
;
          if (!runningTests) {
            require("worldcup/app")["default"].create({"name":"worldcup","version":"0.0.0+79a206e5"});
          }
